    ...
    public static DrawComponent graphicsComponentCharacter(Character character){
        return (g)->{
                ...
                if(character.getDir()==Direction.LEFT){
                    pathKnight = DrawComponentFactory.class.getResource("/assets/character/"+character.getClass().getSimpleName()+"Left"+FORMAT_SPRITE);
                }else{
                    pathKnight = DrawComponentFactory.class.getResource("/assets/character/"+character.getClass().getSimpleName()+"Right"+FORMAT_SPRITE);
                }
                try {
